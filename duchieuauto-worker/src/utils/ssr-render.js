...
// Trang thương hiệu (brand-san-pham.html) - PHÁT HIỆN 2026-08-20 qua GSC Coverage thật: route
// SSR-cho-bot ban đầu (Phase 12) chỉ có product/category/post, THIẾU hẳn loại trang này dù nó cũng
// là URL động (?id=&brand=[&loai=]) và cũng bị Google gắn cờ "chưa lập chỉ mục"/"trang trùng lặp"
// y hệt 2 loại kia. "types" có phần tử nghĩa là thương hiệu này còn phân loại con chưa chọn (hiển
// thị danh sách loại), ngược lại hiển thị thẳng danh sách sản phẩm - đúng logic
// renderBrandProducts() trong assets/js/catalog-render.js.
export function renderBrandHtml({ cat, brand, type, types, products }) {
